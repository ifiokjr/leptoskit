...
/// `DocumentWrapper` is wrapper struct around [`web_sys::Document`]. We use to
/// allow effortless implementation of `DomQuery` trait on any struct that holds
/// onto a [`web_sys::Document`]
